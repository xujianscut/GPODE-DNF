...
def initialize_inducing(model, data_ys, ts_max,data_noise=1e0):
    """
    ...
    with torch.no_grad():
        ...
        inducing_loc = torch.tensor(kmeans2(data_ys, k=100, minit='points')[0])
        ...
        model.flow.odefunc.diffeq.b.data = inducing_val.data  # (M,D)
